...
SPECIALTY_QUESTIONS: dict[str, list[str]] = {
    "sepsis": [
        ...
        "When cultures are feasible, what diagnostic samples should be collected promptly, and how will you avoid delaying antimicrobials?",
    ...
    "dka": [
        "How does insulin deficiency lead to the acid-base disturbance you're seeing?",
        "What is the anion gap telling you, and how would albumin or other factors affect its interpretation?",
    ...
    "stroke": [
        ...
        "Which time anchors, imaging findings, and local protocol criteria must you verify for reperfusion eligibility?",
        "How should the NIHSS, time anchors, and imaging together inform urgency and eligibility?",
        "This patient has atrial fibrillation with recent missed anticoagulant doses — what does that suggest about the stroke mechanism?",
        "How should the blood pressure be interpreted alongside current reperfusion eligibility guidance rather than in isolation?",
        "What imaging would you order first, and what are you specifically looking for?",
        "Beyond IV thrombolysis, what other time-sensitive reperfusion pathway should be assessed, and which criteria trigger it?",
        ...
        "Which local protocol blood-pressure thresholds and safety requirements must be checked before reperfusion treatment?",
    ],
    "pe": [
        "What is this patient's Wells score, and how would you apply each criterion?",
        ...
        "How would you risk-stratify this PE as high-, intermediate-, or low-risk using hemodynamics, RV assessment, and biomarkers?",
        "What information about stability, contraindications, and availability determines whether CT-PA, V/Q scanning, or bedside echo is most appropriate first?",
        "In which high-risk or deteriorating scenario might systemic thrombolysis be considered, and what bleeding checks are essential first?",
...
_SOURCE_CHEST_PAIN = {
    ...
    "supports": [
        ...
        "major contraindications, aspirin allergy, bleeding risk, renal impairment, low body weight, age, dose adjustment, and clotting function safety checks before antithrombotic therapy",
...
_SOURCE_ACS_STATPEARLS = {
    ...
    "supports": [
        ...
        "PCI timing, transfer timing, 12 hour presentation, door-to-needle thrombolysis, and fibrinolysis contraindication planning",
        "antithrombin at the same time as fibrinolysis, post-fibrinolysis ECG 60-90 minutes, rescue PCI for failed reperfusion, and do not repeat fibrinolysis",
        "DAPT choice with prasugrel, ticagrelor, or clopidogrel based on bleeding risk or oral anticoagulant status",
    ],
}
...
_SOURCE_PE = {
    ...
    "supports": [
        ...
        "CTPA, V/Q alternative, bedside echo, and hemodynamic stability pathways",
        ...
        "intermediate-high PE monitoring with RV dysfunction, troponin, BNP, and cardiac biomarker review",
        "no routine thrombolysis or routine primary systemic thrombolysis while hemodynamically stable and reserve rescue thrombolysis for decompensation",
        "catheter-directed therapy, catheter embolectomy, or surgical embolectomy backup when thrombolysis is contraindicated, unavailable, or fails",
...
_SOURCE_PE_STATPEARLS = {
    ...
    "supports": [
        ...
        "CT pulmonary angiography, V/Q alternative, bedside echo, and hemodynamic stability pathways",
...
_SOURCE_DKA_STATPEARLS = {
    ...
    "supports": [
        ...
        "time-critical fluids, IV insulin infusion planning, potassium checks, and anion-gap closure",
        "potassium safety threshold before IV insulin infusion",
...
_SOURCE_STROKE = {
    ...
    "supports": [
        ...
        "blood pressure 185/110 threshold before alteplase",
        "noncontrast head CT to exclude hemorrhage before treatment decision",
        "thrombectomy eligibility screening",
        "CTA, MRA, CT perfusion, MR perfusion, or vascular imaging for thrombectomy selection",
        "NIHSS, modified Rankin, ASPECTS, large vessel occlusion, 6-hour, 24-hour, salvageable tissue, or thrombectomy eligibility review",
        "stroke service, stroke unit, stroke physician, post-thrombolysis complication, follow-up imaging, or re-imaging monitoring",
        "aspirin, antiplatelet, anticoagulation, 24-hour, dysphagia, enteral, rectal, or swallow-route timing review",
        "oxygen, glucose, temperature, and dysphagia swallow supportive safety checks",
...
_SOURCE_STROKE_STATPEARLS = {
    ...
    "supports": [
        ...
        "vascular imaging, CTA, MRA, CT perfusion, or MR perfusion for thrombectomy selection",
        "NIHSS, modified Rankin, ASPECTS, large vessel occlusion, 6-hour, 24-hour, salvageable tissue, or thrombectomy eligibility review",
        "stroke service monitoring and post-thrombolysis follow-up imaging or re-imaging",
        "aspirin, antiplatelet, anticoagulation, 24-hour, dysphagia, enteral, rectal, or swallow-route timing review",
        "oxygen, glucose, temperature, and dysphagia swallow supportive safety checks",
...
_CASE_SEPSIS = {
    ...
    "time_critical_actions": [
        ...
        "Start immediate broad-spectrum antibiotics within 1 hour",
        "Measure lactate and repeat lactate if elevated",
        "Give 30 mL/kg crystalloid fluid resuscitation while reassessing perfusion and volume status",
        "Start norepinephrine vasopressor support targeting MAP 65 if hypotension persists",
        "Arrange source control planning and ICU or critical-care escalation",
    ],
    "contraindication_checks": [
...
_CASE_PE = {
    ...
    "contraindication_checks": [
        ...
        "Baseline blood tests including FBC CBC, platelet count, renal function, hepatic or liver function, PT, and aPTT before or within 24 hours of anticoagulation",
        ...
        "Avoid routine thrombolysis or routine primary systemic thrombolysis while hemodynamically stable and reserve rescue thrombolysis for decompensation",
...
_CASE_DKA = {
    ...
    "time_critical_actions": [
        "Assess severity and initiate monitored DKA protocol with fluids and IV insulin infusion planning",
